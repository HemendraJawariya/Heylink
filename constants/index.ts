...
export const FOOTER_CONTACT_INFO = {
  title: "Contact Us",
  links: [
    { label: "Admin Officer", value: "123-456-7890", url: "tel:7898309711" },
    {
      label: "Email Officer",
      value: "hilink@ankit.com",
      url: "mailto:hemendrajawariya@gmail.com",
    },
  ],
};
...
export const SOURCE_CODE = {
  icon: "/github.svg",
  title: "Github",
  url: "https://github.com/HemendraJawariya/Heylink",
};
